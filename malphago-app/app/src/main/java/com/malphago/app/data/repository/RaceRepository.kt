    ...
    suspend fun syncEntries(raceId: Int) {
        ...
        val entities = entryDtos.map { dto ->
            RaceEntryEntity(
                ...
                horseName = null, // Resolved via join on server side
                jockeyName = null,
                trainerName = null,
                ranking = dto.ranking,
                ...
                horseWeightChange = dto.horseWeightChange,
                raceInterval = dto.raceInterval,
                finishMargin = dto.finishMargin,
                oddsWin = dto.oddsWin,
                oddsPlace = dto.oddsPlace,
